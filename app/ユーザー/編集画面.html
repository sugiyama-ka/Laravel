<!DOCTYPE html>
<!-- saved from url=(0029)http://localhost/users/1/edit -->
<html lang="ja"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- Styles -->
    <link href="./編集画面_files/app.css" rel="stylesheet">
</head>
<body class="bg-light">
    <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
        <a class="navbar-brand" href="http://localhost/users/1/edit#">Laravel</a>
        ...
        <div class="col-sm">
            <form action="http://localhost/users/1" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control " id="name" name="name" value="山藤">
                </div>
    ...
    <!-- Scripts -->
    <script src="./編集画面_files/app.js"></script>
